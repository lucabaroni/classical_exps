...
# stacked_data = stack_neuron_datasets('/project/classical_exp_in_silico/run_pipeline/results_convnext_model.h5')
...
h5 = '/project/classical_exp_in_silico/run_pipeline/results_convnext_model.h5'
